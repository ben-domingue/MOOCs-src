...
setwd("/home/bd/Dropbox/moocs/src/out-order/lief")
source("functions.R")
...
#datagen("MedStat.v2")
load("/home/bd/Dropbox/moocs/data/proc/desc1.Rdata")
dat$`C-19`->L
...
order <- t(apply(L$first_attempt,1,positionTaken))
